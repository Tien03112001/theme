...
@section('content')
    ...
    <section class="news-section">
        <div class="container">
            <div class="news-cat-navi">
                <a href="/blog" class="news-cat">Tất cả</a>
                @foreach($postCategories as $c)
                    <a href="{{$c->full_path}}" class="news-cat {{$category->id == $c->id ? 'active':''}}"
                       title="Danh mục {{$c->name}}">{{$c->name}}</a>
                @endforeach
            </div>
                    ...
                    <div class="news-item">
                        ...
                        <div class="news-item-body">
                            <div class="news-item-info">
                                ...
                                <p class="news-item-des">{!! $post->summary !!}</p>
                            </div>
